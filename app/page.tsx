...
const modulos = [
  {
    titulo: "CRM de leads",
    descricao:
      "Centralize leads, histórico, responsável, status, origem e próximos passos em uma operação única.",
    icon: Users,
  },
  {
    titulo: "Kanban comercial",
    descricao:
      "Acompanhe cada negociação por etapa, visualize pendências e avance oportunidades com controle.",
    icon: LineChart,
  },
  {
    titulo: "Agenda e visitas",
    descricao:
      "Organize agendamentos, test-drives, visitas na loja, retornos e follow-ups importantes.",
    icon: CalendarDays,
  },
  {
    titulo: "Monitor WhatsApp",
    descricao:
      "Identifique respostas, conversas fora da base, WhatsApp sem 3CX e clientes sem retorno.",
    icon: MessageCircle,
  },
  {
    titulo: "Controle 3CX",
    descricao:
      "Cruze ligações com leads para entender se o contato foi feito antes do WhatsApp.",
    icon: PhoneCall,
  },
  {
    titulo: "Conferência de veículos",
    descricao:
      "Acompanhe divergências, validações e informações importantes da operação de estoque.",
    icon: CarFront,
  },
  {
    titulo: "Relatórios por unidade",
    descricao:
      "Compare lojas, responsáveis, conversões, agendamentos e pendências em tempo real.",
    icon: BarChart3,
  },
  {
    titulo: "Gestão de usuários",
    descricao:
      "Controle perfis, permissões, status operacional, recebimento de leads e acessos internos.",
    icon: ShieldCheck,
  },
];
...
const perfis = [
  {
    ...
    descricao:
      "Visão completa da operação, permissões, relatórios, usuários, unidades e indicadores estratégicos.",
    icon: Crown,
  },
  {
    titulo: "Suporte",
    descricao:
      "Apoio ao time com validações, conferências, auditorias e resolução de pendências operacionais.",
    icon: Headphones,
  },
  {
    titulo: "Colaborador",
    descricao:
      "Tela prática para atender leads, acompanhar agenda, registrar evolução e evitar esquecimentos.",
    icon: Users,
  },
];
...
const perguntas = [
  {
    ...
    resposta:
      "Não. O Flow Sales CRM atua como camada operacional para organizar recuperação de leads, agenda, acompanhamento, auditoria de WhatsApp, 3CX e relatórios. O C2S continua como uma fonte importante da base.",
  },
  {
    pergunta: "Como o Monitor WhatsApp ajuda a operação?",
    resposta:
      "Ele mostra se o cliente está na base, se teve ligação 3CX, se respondeu no WhatsApp, se existe conversa fora da base e se o atendimento não foi atualizado corretamente.",
  },
  {
    pergunta: "O sistema controla permissões por perfil?",
    resposta:
      "Sim. A estrutura foi pensada para administrador, suporte, supervisor/gerente e colaborador, com acesso diferente conforme a função.",
  },
  {
    pergunta: "Consigo acompanhar resultados por loja?",
    resposta:
      "Sim. Os relatórios e indicadores foram pensados para visão por unidade, equipe, responsável e situação dos leads.",
  },
];
...
function IconBox({
  ...
  return (
    <div
      className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-blue-50 text-blue-700 ring-1 ring-blue-100 ${className}`}
    >
      {children}
    </div>
  );
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-white/90 backdrop-blur-xl">
        <div className="mx-auto flex h-[74px] w-full max-w-[1640px] items-center justify-between px-6 lg:px-10">
          ...
          <nav className="hidden items-center gap-9 text-sm font-extrabold text-slate-700 lg:flex">
            <a href="#produto" className="flex items-center gap-1 transition hover:text-blue-700">
              Produto <ChevronDown className="h-3.5 w-3.5" />
            </a>
            <a href="#solucoes" className="flex items-center gap-1 transition hover:text-blue-700">
              Soluções <ChevronDown className="h-3.5 w-3.5" />
            </a>
            <a href="#recursos" className="flex items-center gap-1 transition hover:text-blue-700">
              Recursos <ChevronDown className="h-3.5 w-3.5" />
            </a>
            <a href="#perguntas" className="transition hover:text-blue-700">
              Perguntas
            </a>
        ...
        <div className="relative mx-auto grid min-h-[650px] w-full max-w-[1640px] items-center gap-12 px-6 py-14 lg:grid-cols-[0.88fr_1.12fr] lg:px-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-7 max-w-2xl text-lg font-semibold leading-8 text-slate-600">
              O Flow Sales CRM centraliza leads, agenda, 3CX, WhatsApp, conferência,
              equipe e relatórios em um só lugar. Mais controle, mais produtividade e
            ...
            <div className="absolute right-0 top-0 w-[860px] overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-3 shadow-2xl shadow-blue-950/14">
              ...
              <div className="overflow-hidden rounded-[1.55rem] border border-slate-100 bg-slate-50">
                <img
                  ...
                  alt="Dashboard operacional do Flow Sales CRM"
        ...
        <div className="mx-auto grid max-w-[1420px] gap-8 lg:grid-cols-[0.75fr_1.25fr]">
          <div>
            ...
            <h2 className="mt-3 text-4xl font-black tracking-[-0.05em] text-slate-950">
              Dúvidas comuns antes de usar o Flow.
            </h2>
            <p className="mt-4 text-base font-semibold leading-7 text-slate-600">
              Respostas diretas sobre como o sistema ajuda a controlar leads, atendimento,
              WhatsApp, 3CX e a rotina comercial.
            </p>

            <Link
              href="/perguntas-frequentes"
              className="mt-6 inline-flex h-12 items-center gap-2 rounded-xl bg-blue-700 px-5 text-sm font-black text-white shadow-lg shadow-blue-700/20 transition hover:bg-blue-800"
            >
          ...
          <div className="flex flex-col items-center justify-between gap-6 text-center lg:flex-row lg:text-left">
            <div>
              ...
              <p className="mt-2 text-base font-semibold text-blue-50">
                Solicite uma demonstração e receba o contato da nossa equipe.
              </p>
            </div>
      ...
      <footer id="contato" className="border-t border-slate-200 bg-white px-6 py-8 lg:px-10">
        <div className="mx-auto flex max-w-[1420px] flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="grid gap-4 text-sm font-bold text-slate-500 sm:grid-cols-5 lg:gap-12">
            ...
            <Link href="/inscreva-se" className="hover:text-blue-700">Entrar</Link>
          </div>
        </div>
      </footer>
    </main>
